...
#IPV6
# PORT 80
ufw allow from 2400:cb00::/32 to any port 80 proto tcp 
ufw allow from 2606:4700::/32 to any port 80 proto tcp 
ufw allow from 2803:f800::/32 to any port 80 proto tcp 
ufw allow from 2405:b500::/32 to any port 80 proto tcp 
ufw allow from 2405:8100::/32 to any port 80 proto tcp 
ufw allow from 2a06:98c0::/29 to any port 80 proto tcp 
ufw allow from 2c0f:f248::/32 to any port 80 proto tcp 
...
#LOCAL IP
# PORT 80
ufw allow from 127.0.0.0/8 to any port 80 proto tcp  
...
# PORT 443
ufw allow from 127.0.0.0/8 to any port 443 proto tcp 
